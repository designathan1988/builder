...
// disabled with its reason and a key reports it in the status bar, changing nothing. (The toast's Undo arrives with
// delete-element, the command bar's with command-bar.)
