...
export interface CommandArgs {
  ...
  "element.setInputType": { readonly type: "text" | "hidden" | "email" | "password" | "number" | "tel" | "url" | "search" | "date" | "datetime-local" | "month" | "week" | "time" | "color" | "range" | "checkbox" | "radio" | "file" | "image" | "button" | "submit" | "reset" };
...
export const FEATURE_COMMANDS: Readonly<Record<FeatureId, readonly CommandId[]>> = {
  ...
  "settings-audit": ["element.setAttribute","element.setInputType","element.setClasses","element.setCustomAttribute","element.setTag","text.toggleMark","classes.rename","classes.delete"],
